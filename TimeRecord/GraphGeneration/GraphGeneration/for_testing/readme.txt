...
================================
-run_GraphGeneration.sh (shell script for temporarily setting environment variables and 
 executing the application)
   -to run the shell script, type
   
       ./run_GraphGeneration.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v84, run the shell script as:
       ...
       ./run_GraphGeneration.sh /mathworks/home/application/v84
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_GraphGeneration.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
   -if end users are unable to download the MATLAB runtime using the above  
    link, include it when building your component by clicking 
    the "Runtime downloaded from web" link in the Deployment Tool
-The Macintosh bundle directory structure GraphGeneration.app 
   -this can be gathered up using the zip command 
    zip -r GraphGeneration.zip GraphGeneration.app
    or the tar command 
    tar -cvf GraphGeneration.tar GraphGeneration.app
-This readme file 
...
A. Mac systems:
   ...
   Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_GraphGeneration.sh 
